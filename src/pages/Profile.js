...
import { PROFILE_UPDATE } from '../utils/actions';
import { useStoreContext } from '../utils/GlobalState';
import { Link } from 'react-router-dom';
import API from '../utils/API';
import CurrentPassword from '../AuthComponents/UserProfileInputs/CurrentPassword';
import Email from '../AuthComponents/UserProfileInputs/Email';
import Username from '../AuthComponents/UserProfileInputs/Username';
...
const Profile = () => {
  ...
  return (
    <Container>
      <h1>Your Profile:</h1>
      <p> Protected dashboard: <Link to="/dashboard">Dashboard</Link></p>
